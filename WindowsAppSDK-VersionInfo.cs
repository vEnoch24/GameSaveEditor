...
namespace Microsoft.WindowsAppSDK
{
    ...
    internal class Release
    {
        ...
        internal const ushort Patch = 909;
    ...
    namespace Runtime
    {
        ...
        internal class Version
        {
            ...
            internal const ulong UInt64 = 0x1B58026908370000;

            /// The version of the Windows App SDK runtime, as a string (const wchar_t*); for example, "1000.446.804.0".
            internal const string DotQuadString = "7000.617.2103.0";
        }
        ...
        namespace Packages
        {
            ...
            namespace DDLM
            {
                internal class X86
                {
                    ...
                    internal const string PackageFamilyName = "Microsoft.WinAppRuntime.DDLM.7000.617.2103.0-x8_8wekyb3d8bbwe";
                }
                internal class X64
                {
                    /// The Windows App SDK runtime's Dynamic Dependency Lifetime Manager (DDLM) package's family name, for x64.
                    internal const string PackageFamilyName = "Microsoft.WinAppRuntime.DDLM.7000.617.2103.0-x6_8wekyb3d8bbwe";
                }
                internal class Arm64
                {
                    ...
                    internal const string PackageFamilyName = "Microsoft.WinAppRuntime.DDLM.7000.617.2103.0-a6_8wekyb3d8bbwe";
                }
            }
        }
    }
