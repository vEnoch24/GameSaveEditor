...
@compressed_assembly_descriptors = dso_local local_unnamed_addr global [141 x %struct.CompressedAssemblyDescriptor] [
	...
	%struct.CompressedAssemblyDescriptor {
		i32 2109952, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
	...
	%struct.CompressedAssemblyDescriptor {
		...
		i1 false, ; bool loaded
		i32 13549672; uint32_t buffer_offset
	}, ; 138: Java.Interop
	%struct.CompressedAssemblyDescriptor {
		i32 22368, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 13720680; uint32_t buffer_offset
	}, ; 139: Mono.Android.Runtime
	%struct.CompressedAssemblyDescriptor {
		i32 2036736, ; uint32_t uncompressed_file_size
		i1 false, ; bool loaded
		i32 13743048; uint32_t buffer_offset
	} ; 140: Mono.Android
], align 16

@uncompressed_assemblies_data_size = dso_local local_unnamed_addr constant i32 15779784, align 4

@uncompressed_assemblies_data_buffer = dso_local local_unnamed_addr global [15779784 x i8] zeroinitializer, align 16
