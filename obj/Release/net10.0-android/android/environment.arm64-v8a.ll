...
@dso_apk_entries = dso_local local_unnamed_addr global [115 x %struct.DSOApkEntry] zeroinitializer, align 8
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [31 x i8] c"com.companyname.gamesaveeditor\00", align 1
...
@.DSOCacheEntry.9_name = private unnamed_addr constant [29 x i8] c"libaot-GameSaveEditor.dll.so\00", align 1
...
@.DSOCacheEntry.37_name = private unnamed_addr constant [51 x i8] c"libaot-SQLitePCLRaw.lib.e_sqlcipher.android.dll.so\00", align 1
@.DSOCacheEntry.38_name = private unnamed_addr constant [48 x i8] c"libaot-SQLitePCLRaw.provider.e_sqlcipher.dll.so\00", align 1
@.DSOCacheEntry.39_name = private unnamed_addr constant [57 x i8] c"libaot-System.Security.Cryptography.ProtectedData.dll.so\00", align 1
...
@.DSOCacheEntry.85_name = private unnamed_addr constant [43 x i8] c"libaot-System.IO.FileSystem.Watcher.dll.so\00", align 1
